    ...
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex item-center gap-3">
        ...
        <li className="w-8 h-8 rounded-full ring-1 ring-gray-300 cursor-not-allowed relative bg-green-500">
          <div className="h-[2px] w-10 absolute bg-lama rotate-45 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
        </li>
      </ul>
      ...
      <ul className="flex item-center gap-3">
        ...
        <li className="ring-1 ring-white bg-pink-200 text-white rounded-md py-1 px-4 text-sm cursor-not-allowed">
          Large
        </li>
      </ul>
    </div>
